        ...
        <form>
            <!-- <fieldset> -->
                ...
                <div class="form-group">
                    ...
                    <input type="tel"  name="phone" class="form-control" id="phone" aria-describedby="phoneHelp" pattern="0[1-9][0-9]{8}" placeholder="Entrez votre prenom ici" required="">
                </div>
                ...
                <div class="form-check">
                    <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="question2" id="question21" value="1">
                    Oui
                    </label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="question2" id="question22" value="-1">
                    Non
                    </label>
                </div>
